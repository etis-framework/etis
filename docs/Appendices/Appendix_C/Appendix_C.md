...
## Repository-Centered Engineering Artifact Catalog

**A lifecycle catalog of the evidence, records, and engineering memory preserved in trustworthy repositories**

Repository-centered engineering treats the repository as the system of record for engineering truth—not merely as a code host or document store.

This appendix catalogs the major artifact families that preserve intent, decisions, implementation evidence, reviews, verification, release readiness, operations, incidents, AI governance, learning, and stewardship. It provides a reference architecture without prescribing one toolchain or mandatory folder structure.
