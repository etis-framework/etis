...
<div style="display:grid; grid-template-columns:repeat(2,minmax(140px,230px)); justify-content:center; gap:1.5rem; width:100%; max-width:490px; margin:1.55rem auto .9rem auto;">
  <a href="../Volumes/Volume_I/" style="display:block; text-decoration:none;">
    <img src="../assets/books/etis-framework/volume-1-cover.png"
         ...
         style="display:block; width:100%; height:auto; margin:0; border:1px solid #d9d9d9; box-shadow:0 10px 30px rgba(0,0,0,.12); border-radius:.25rem;">
  </a>
  ...
  <div style="flex:0 0 220px;">
    <a href="engineering-judgment/" style="display:block; text-decoration:none;">
      <img src="../assets/books/engineering-judgment/front-cover.png"
           ...
           style="display:block; width:220px; max-width:100%; height:auto; margin:0; border:1px solid #d9d9d9; box-shadow:0 10px 30px rgba(0,0,0,.12); border-radius:.25rem;">
    </a>
  </div>
