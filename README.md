...
The official ETIS website is published at:
...
The `docs/` directory is the source of truth for the online publication website.
...
Official ETIS releases are published through GitHub Releases.
