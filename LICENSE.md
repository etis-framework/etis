...
Copyright © 2026 William T. O'Connell
...
Except as permitted by applicable copyright law, no part of this repository may be reproduced, distributed, transmitted, displayed, published, modified, adapted, translated, incorporated into derivative works, stored in a retrieval system, or used for commercial purposes without the prior written permission of the copyright holder.
...
- Website content
- Platform gateway content
- Framework descriptions
- Repository architecture
- Navigation architecture
- Resource Center content
- ETIS Library content
- Download assets
- Templates and examples contained in this repository
...
- View and read repository contents through authorized publication channels.
- Clone or download the repository solely for personal, non-commercial reference and evaluation.
- Quote brief excerpts for review, commentary, criticism, teaching, scholarship, or research purposes as permitted by applicable law.

Permission is not granted to:

- Republish substantial portions of the work.
- Create derivative books, courses, publications, or commercial training based upon the work.
- Redistribute repository contents.
- Modify and redistribute repository materials.
- Use ETIS figures, diagrams, visual assets, or framework materials in other publications without written permission.
...
THE MATERIALS IN THIS REPOSITORY ARE PROVIDED "AS IS" WITHOUT WARRANTY OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, OR NON-INFRINGEMENT.
